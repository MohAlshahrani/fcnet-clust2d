function [imgs, ground_truth, st_boxes] = load_video_info_votformat(base_path, video)
%LOAD_VOT_VIDEO_INFO
...
%   http://www.isr.uc.pt/~henriques/
    ...
    st_boxes = csvread([video_path 'siamese.txt']);
    %ground_truth = readmatrix([video_path 'groundtruth.txt'], 'Delimiter', '   ');
    %ground_truth = ground_truth(:, 3:4);
    %disp(ground_truth);
